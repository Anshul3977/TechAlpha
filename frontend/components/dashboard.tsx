      ...
      <Card className="p-6">
        ...
        <Tabs defaultValue="all" className="w-full">
          ...
          <TabsContent value="wins" className="py-4">
            <ActivityList filtered="wins" />
          </TabsContent>
          <TabsContent value="losses" className="py-4">
            <ActivityList filtered="losses" />
          </TabsContent>
        </Tabs>
      </Card>
    </div>
...
function ActivityList({ filtered }: { filtered?: "wins" | "losses" }) {
  const activities = [
    {
      id: 1,
      market: "BTC $100k by 2024",
      outcome: "Yes",
      amount: "100 ZETA",
      result: "win",
      date: "2024-03-20",
    ...
    filtered ? activity.result === filtered : true
  );
